...
\newfontfamily\textb{Pretendard Bold}
...
\providecommand{\RuleAssetPath}{assets/formula}
\providecommand{\RuleIndexStart}{}
\providecommand{\RuleIndexEnd}{}
\graphicspath{{assets/}}
\captionsetup[figure]{
  name=그림,
  labelsep=period,
...
\newcommand{\fig}[3]{
  \begin{figure}[H]
    \centering
    \includegraphics[width=#3\linewidth]{\RuleAssetPath/#1.jpg}
...
\newcommand{\figwithcaption}[4]{
  \begin{figure}[H]
    \centering
    \includegraphics[width=#4\linewidth]{\RuleAssetPath/#1.jpg}
